...
def crawl_content(url):
    ...
    if not os.path.exists(file_path):
        with open(file_path, "a", encoding="utf-8") as file:
            ...
            # get img
            WebDriverWait(driver, 10).until(EC.presence_of_element_located((By.CSS_SELECTOR, "figure > img")))
            ...
            image_element = driver.find_element(By.CSS_SELECTOR, "figure>img") if driver.find_elements(By.CSS_SELECTOR, "figure>img") else None
            if image_element:
                WebDriverWait(driver, 10).until(EC.presence_of_element_located((By.CSS_SELECTOR, "figure > img[src]")))
